...
export function FinanceiroDashboard({ data, currentMonth, currentYear }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs */}
      <div className="flex gap-1 bg-zinc-900 border border-zinc-800 rounded-[4px] p-1 w-fit">
        <button
          onClick={() => setActiveTab('reservas')}
          className={`flex items-center gap-2 px-4 py-2 rounded-[2px] text-sm font-medium transition-all cursor-pointer ${
            activeTab === 'reservas'
